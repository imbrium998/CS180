...
public class PizzaGUI extends JFrame implements ActionListener {
	 ...
	 */
	public PizzaGUI() throws IOException {

		super("Pizza interface");

		BufferedImage myPicture = ImageIO.read(new File("./pic3.jpg"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==done){
			...
			double price = newpizza.calcPrice(newpizza.numToppings(),newpizza.getSize());   //   What happened here?
